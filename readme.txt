=== Whateverweb for Wordpress ===
Contributors: sgal
Tags: whateverweb, optimisation
...
This plugin provides a basic integration to Whateverweb optimisation services. Requires an active application at http://whateverweb.com
...
1. Upload `whateverweb` folder to the `/wp-content/plugins/` directory
...
= 1.0 =
* Basic integration to Image and CSS Optimisers
